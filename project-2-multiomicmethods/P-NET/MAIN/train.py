...
def train(model,train_input_array,test_input_array,train_labels,test_labels, device, batch_size=64, learning_rate=0.01, lr_decay=0.5, num_epochs=10, sparse=False):
    """
    Trains a given model with specified parameters and data.

    Args:
        model: Model to be trained.
        train_input_array (numpy.ndarray): Input features array from train set.
        test_input_array (numpy.ndarray): Input features array from test set.
        train_labels (numpy.ndarray): Corresponding labels array from train set.
        test_labels (numpy.ndarray): Corresponding labels array from test set.
